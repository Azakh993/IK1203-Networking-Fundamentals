...
public class HTTPAsk implements Runnable{
    ...
    private final String CONNECTION = "Connection: close" + NEWLINE;
    private final String CONTENT_TYPE = "Content-Type: text/plain" + NEWLINE;
    private HashMap< String, Object > arguments;

    HTTPAsk(Socket socket, int connectionNumber) {
        this.socket = socket;
        ...
        try {
            while (true) {
                try {
                    ...
                    System.out.println("(" + CONNECTION_NUMBER + ") Processed request...");
                    ...
                    socket.close();
                    System.out.println("(" + CONNECTION_NUMBER + ") Closed connection!");
    ...
    private String read_request(Socket socket) throws IOException {
    ...
    private void parse_and_set_parameters(String unparsedRequest) {
    ...
    private String get_http_status_code(String unparsedParameters) {
    ...
    private void output_response_header(OutputStream output, int responseSize) throws IOException {
    ...
    private void output_data(OutputStream output, byte[] serverResponse) throws IOException {
    ...
    private void output_response_header(OutputStream output, String http_status_code) throws IOException {
    ...
    private boolean verify_url(String unparsedParameters) {
